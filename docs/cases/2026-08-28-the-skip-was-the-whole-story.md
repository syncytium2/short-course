<!-- Case study, imported 2026-08-28. Evidence: commits and files in syncytium2/bugarach (public) and in this repo. An outside reader can check all of it. -->
...
> 2026-08-28; every command is in the appendix. That is the same position as incident B of
...
[sibling case](2026-08-27-computed-instead-of-asking.md), incident B — **one owner for the fact,
