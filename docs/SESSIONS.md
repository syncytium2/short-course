...
### Tonys-MacBook-Pro/4a487730 — Front page: drop the draft stamp (keep it on the three sheets) and rewrite the standfirst fragment
- **Status:** DONE 2026-08-31
- **Opened:** 2026-08-31
...
### Tonys-MacBook-Pro/59c48a26 — Cold Start beginner read: undefined jargon (remote, commit, push, nameserver, zone, WHOIS, certificate), route/road collision, forward references in the door, and three dangling cross-references my own tier edits created
- **Status:** DONE 2026-09-01
- **Opened:** 2026-09-01
- **Branch when opened:** `cold-start-tier-repair` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/59c48a26 — New handout: a plain-language git one-pager the other sheets can link to, scope-limited on purpose, linking out to the real resources
- **Status:** DONE 2026-09-01
- **Opened:** 2026-09-01
- **Branch when opened:** `cold-start-tier-repair` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/59c48a26 — Rename the git sheet to Just Enough Git — title, filename and URL, per the estate's URL-matches-title convention
- **Status:** DONE 2026-09-01
- **Opened:** 2026-09-01
...
### Tonys-MacBook-Pro/3a789141 — --help
- **Status:** DONE 2026-09-01
- **Opened:** 2026-09-01
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/3a789141 — Record instances 7 and 8 against finding N5 in OPEN-FINDINGS.md — evidence rows only, no wording change to B4
- **Status:** DONE 2026-09-01
- **Opened:** 2026-09-01
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/3a789141 — Remove resolvable pointers to interface2's private address from two case files — Tony's call, no other content touched
- **Status:** DONE 2026-09-02
- **Opened:** 2026-09-02
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/59c48a26 — W2 assumes the reader arrives with an idea; add a starter-project generator for the ones who just want to try something
- **Status:** DONE 2026-09-02
- **Opened:** 2026-09-02
...
### Tonys-MacBook-Pro/59c48a26 — Tier-hidden elements are still visible: [data-off] loses to later same-specificity display rules. Plus checkbox rows no longer line up, and suggested prompts in the why answers
- **Status:** DONE 2026-09-02
- **Opened:** 2026-09-02
...
### Tonys-MacBook-Pro/59c48a26 — Add CI: run every gate on push and PR, plus a staleness job that reports the live-vs-master gap without failing
- **Status:** DONE 2026-09-02
- **Opened:** 2026-09-02
...
### Tonys-MacBook-Pro/59c48a26 — CI's first run: check_pointers audits node_modules, which only exists in CI
- **Status:** DONE 2026-09-02
- **Opened:** 2026-09-02
...
### Tonys-MacBook-Pro/59c48a26 — Move W2's starter-project generator out of the fold into the page, expand the pool, and make one draw in three blue sky
- **Status:** DONE 2026-09-02
- **Opened:** 2026-09-02
...
### Tonys-MacBook-Pro/9bf3acb0 — Correct B2's evidence list (Southampton does not refute the vacancy claim) and close B5's three-email residual as decided-against
- **Status:** DONE 2026-09-02
- **Opened:** 2026-09-02
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/9bf3acb0 — Correct the new case's characterisation of its predecessor: the 08-29 board WAS written on correctly, so the pair is closer than the file claims
...
### Tonys-MacBook-Pro/9bf3acb0 — Add the reviewer's near-miss as finding 4 of the four-sessions case, promote its finding 3 in the audience note, and record where the check_milestones fixes are routed
- **Status:** DONE 2026-09-03
- **Opened:** 2026-09-03
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Mac/e8b745b6 — Session close: record M8 and two loose ends in HANDOFF.md's cold-start section
- **Status:** DONE 2026-09-06
- **Opened:** 2026-09-06
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Mac/9bf3acb0 — Session close: darkroom index was overwritten and is rebuilt; merged branches cleared; one finished case still stranded with no PR
- **Status:** DONE 2026-09-06
- **Opened:** 2026-09-06
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
...
### Mac/9bf3acb0 — Master is red on a real defect my port fix exposed: .stop-head does not wrap, so .stop-tag overflows at 390px
- **Status:** DONE 2026-09-06
- **Opened:** 2026-09-06
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Mac/75e4d067 — cold-start: the antecedent read (every pronoun and positional reference resolves inside its step), plus the reader's selections printed inline at each word; rebuild
- **Status:** DONE 2026-09-06
- **Opened:** 2026-09-06
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/75e4d067 — cold-start: the pronoun sweep — bare it/they/those in reader prose, page-wide
...
### Tonys-MacBook-Pro/75e4d067 — Hand the winter workshop proposal off to its own session: dedicated handoff, source into docs/drafts, pointer from HANDOFF.md
- **Status:** DONE 2026-09-08
- **Opened:** 2026-09-08
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/75e4d067 — what-it-costs: an average was called a ceiling on a live money page — 2026-08-29 blocking finding, never repaired
- **Status:** DONE 2026-09-09
- **Opened:** 2026-09-09
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Tonys-MacBook-Pro/75e4d067 — Remove the browser route everywhere; park the material for reinstatement
- **Status:** DONE 2026-09-09
- **Opened:** 2026-09-09
- **Branch when opened:** `master` — a fact, not an identity; it may move under you
- **Writes:** `docs/handouts/cold-start.html`, `site/cold-start.html`, `tools/claim.sh`
...
### Arioch/dbead6db — cold-start.html — The Short Path as the first route; tier/browser/mutation checks; site build
